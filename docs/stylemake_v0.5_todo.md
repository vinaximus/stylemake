...
## Phase 6 — Item Issue Records (per PO) ✅ COMPLETED

- [X] **Issue — Create & link to PO**
...
- [X] **Issue — Edit/Delete & view by PO**

  - Acceptance criteria:
    - Issues editable/deletable. ✅
    - Issue list view filterable by PO and Date. ✅

- [X] **Show issues on PO detail**

  - Acceptance criteria:
    - PO detail displays a list of Issues linked to it with totals. ✅
- [X] **Ability to add issues directly from PO Detail**

  - Acceptance criteria:
    - PO detail displays a button to issue new items. ✅

- [X] Show List of issues on Cutting Detail

  - Acceptance criteria:
    - Cutting detail displays list of issues related to that cutting. ✅
